  ...
  setOpen(!open)
    ...
    return (<Container maxWidth='xl' sx={{height:'100%', width:"100%"}}> <AppBar elevation={10} color="primary" sx={{height:"auto", width:"100%"}}>
            ...
            <Toolbar>
                ...
                <Card sx={{ width:"100%"}}><Box sx={{height:'250px'}}><CardMedia sx={{objectFit:"fill", height:'250px'}} component='img' src={Tweetle}></CardMedia></Box><CardContent><Typography variant='h6' className='typography' sx={{color:"#6CABC1"}}>Tweetle (Deprecated)</Typography><Typography sx={{color:"white"}} variant='h9'>Tweetle is a tweet guessing game based on wordle. You have 5 attempts to guess who made the tweet of the day</Typography></CardContent><CardActions><Link to='https://github.com/avocadocoder73/Tweetle'><Github></Github></Link></CardActions></Card>
